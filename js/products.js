...
const FOOTBALL90_PRODUCTS = [
  ...
  { id: 17, name: '2026 Barcelona Home Jersey', team: 'Barcelona', country: 'Spain', league: 'La Liga', season: '2026', category: 'Club', kitType: 'Home', price: 3799, sizes: ['S', 'M', 'L', 'XL', 'XXL'], rating: 4.9, description: 'A regal navy and red jersey shaped for confident style and club pride.', image: teamProductImage('Barcelona'), badge: 'New' },
  ...
  { id: 19, name: '2026 Juventus Home Jersey', team: 'Juventus', country: 'Italy', league: 'Serie A', season: '2026', category: 'Club', kitType: 'Home', price: 3699, sizes: ['S', 'M', 'L', 'XL', 'XXL'], rating: 4.8, description: 'Black-and-white heritage design with premium details and a strong modern finish.', image: teamProductImage('Juventus'), badge: 'World Cup' },
  { id: 20, name: '2026 AC Milan Home Jersey', team: 'AC Milan', country: 'Italy', league: 'Serie A', season: '2026', category: 'Club', kitType: 'Home', price: 3699, sizes: ['S', 'M', 'L', 'XL', 'XXL'], rating: 4.7, description: 'Rich red and black energy elevated with a classic Italian football edge.', image: teamProductImage('AC Milan'), badge: 'Best Seller' },
